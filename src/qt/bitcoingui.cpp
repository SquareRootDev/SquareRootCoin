/*
 * Qt4 SquareRootCoin GUI.
 *
 * W.J. van der Laan 2011-2012
 * The Bitcoin Developers 2011-2012
 * The SquareRootCoin Developers 2011-2013
 */
...
{
    resize(850, 550);
    setWindowTitle(tr("SquareRootCoin Wallet"));
#ifndef Q_WS_MAC
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setToolTip(tr("Send coins to a SquareRootCoin address"));
    ...
    aboutAction->setToolTip(tr("Show information about SquareRootCoin"));
    aboutAction->setMenuRole(QAction::AboutRole);
    aboutQtAction = new QAction(tr("About &Qt"), this);
    aboutQtAction->setToolTip(tr("Show information about Qt"));
    aboutQtAction->setMenuRole(QAction::AboutQtRole);
    optionsAction = new QAction(QIcon(":/icons/options"), tr("&Options..."), this);
    optionsAction->setToolTip(tr("Modify configuration options for SquareRootCoin"));
    optionsAction->setMenuRole(QAction::PreferencesRole);
    toggleHideAction = new QAction(QIcon(":/icons/toolbar"), tr("Show/Hide &SquareRootCoin"), this);
    toggleHideAction->setToolTip(tr("Show or hide the SquareRootCoin window"));
...
#ifndef Q_WS_MAC
            setWindowIcon(QIcon(":icons/SquareRootCoin_testnet"));
#else
            MacDockIconHandler::instance()->setIcon(QIcon(":icons/SquareRootCoin_testnet"));
#endif
            if(trayIcon)
            {
...
void BitcoinGUI::createTrayIcon()
{
    ...
    trayIcon->setToolTip(tr("SquareRootCoin client"));
    ...
    notificator = new Notificator(tr("SquareRootCoin-qt"), trayIcon);
}
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to SquareRootCoin network", "", count));
}
